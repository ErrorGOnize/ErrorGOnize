    ...
    <Container sx={{  pt:7, width: "calc(75vw)"}}>
      <Box display="flex" flexDirection="row" sx={{ pl: 10, pr: 10 }}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={8}>
            <h3>홍길동</h3>
            <p>대구와 경북 동부 10개 시군에 내려졌던 초미세먼지 주의보는 오후 들어 모두 해제됐습니다.주의보는 해제됐지만 내일도 대구의 초미세먼지 농도는 매우 나쁨, 경북은 나쁨에 오후 들어 일시적으로 매우 나쁨 수준이 예상돼, 야외활동 시 주의가 필요합니다.</p>
            <p>website: 😛😝😜</p>
          </Grid>
        </Grid>
      </Box>
      ...
      <Box display="flex" flexDirection="column" sx={{ pt: 3, mb: 3, pl: 10, pr: 10 }}>
